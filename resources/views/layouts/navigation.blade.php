            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @auth
                        ...
                        <x-nav-link :href="route('disabilities.index')" :active="request()->routeIs('disabilities.*')">
                            {{ __('إدارة الإعاقات') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @auth
                ...
                <x-responsive-nav-link :href="route('disabilities.index')" :active="request()->routeIs('disabilities.*')">
                    {{ __('إدارة الإعاقات') }}
                </x-responsive-nav-link>
            ...
            @else
                <x-responsive-nav-link :href="route('applicants.create')" :active="request()->routeIs('applicants.create')">
                    {{ __('التقديم') }}
                </x-responsive-nav-link>
            @endauth
        </div>
