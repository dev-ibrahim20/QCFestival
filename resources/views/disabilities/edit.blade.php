        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h1 class="text-3xl font-bold text-gray-800 mb-6">تعديل الإعاقة: {{ $disability->name }}</h1>
                    ...
                    <form action="{{ route('disabilities.update', $disability) }}" method="POST" class="space-y-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <input type="text" id="name" name="name"
                                ...
                                value="{{ old('name', $disability->name) }}" required>
                            ...
                            <input type="text" id="description" name="description"
                                ...
                                value="{{ old('description', $disability->description) }}" required>
                            @error('name')
